...
> By default, the backend saves export files **relative to the IMWEBs-Viewer app’s installation directory**, typically at: `{IMWEBs-Viewer App Path}/_up_/backend/apppy/_internal/dataExport`

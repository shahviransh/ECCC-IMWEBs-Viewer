<template>
    <div :class="[theme, 'select-container']">
        <div class="form-container-ref">
            <div v-if="['Time','Date'].includes(daType)">
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                <label for="date-start-date" v-if="['Time','Date'].includes(daType)">Start Date:</label>
                <label for="date-start-text" v-else-if="daType === 'Month'">Start Month:</label>
                <input id="date-start" type="date" v-if="['Time','Date'].includes(daType)" v-model="selectedDateStart"
                    class="input-field" />
                <input id="date-start" type="text" v-else-if="daType === 'Month'" v-model="selectedDateStart"
                    placeholder="Enter month" class="input-field" />
            </div>
            <div class="form-group">
                <label for="date-end-date" v-if="['Time','Date'].includes(daType)">End Date:</label>
                <label for="date-end-text" v-else-if="daType === 'Month'">End Month:</label>
                <input id="date-end" type="date" v-if="['Time','Date'].includes(daType)" v-model="selectedDateEnd"
                    class="input-field" />
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                <label for="exp-date-start-date" v-if="['Time','Date'].includes(daType)">Start Date:</label>
                <label for="exp-date-start-text" v-else-if="daType === 'Month'">Start Month:</label>
                <input id="exp-date-start" type="date" v-if="['Time','Date'].includes(daType)" v-model="expDateStart"
                    class="input-field" />
            ...
            <div class="form-group">
                <label for="exp-date-end-date" v-if="['Time','Date'].includes(daType)">End Date:</label>
                <label for="exp-date-end-text" v-else-if="daType === 'Month'">End Month:</label>
                <input id="exp-date-end" type="date" v-if="['Time','Date'].includes(daType)" v-model="expDateEnd"
                    class="input-field" />
